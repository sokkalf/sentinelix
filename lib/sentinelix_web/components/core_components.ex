defmodule SentinelixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SentinelixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SentinelixWeb.Gettext, "errors", msg, opts)
    end
  end
